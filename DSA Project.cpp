...
class Graph {
private:
    int G[V][V];  // Graph represented as an adjacency matrix
    string city[V] = {"Islamabad", "Multan", "Faislabad", "Lahore", "Sadiq Abad", "Quetta", "Karachi"};
...
public:
    ...
    void enter_Complain(int bus_serial_number) {
        ...
        if (bus == NULL) {
            ...
            string complain;
            cout << "Enter complain: ";
            getline(cin >> ws, complain); // Read entire line including spaces
            ...
            if (bus->complains_front == NULL) {
                ...
                // Insert the complaint based on your desired logic (e.g., priority).
                // Update the logic here to fit your requirements.
                ...
                if (prev == NULL) {
                    // The queue is empty, insert at the front.
...
//						cin>>age;
				...
				case 5:
				{
				    ...
				    // Find and display the maximum distance in the graph
				    ...
				    // Find and display the minimum distance in the graph
